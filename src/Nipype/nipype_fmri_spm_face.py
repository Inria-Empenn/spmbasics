...
level1.base_dir = os.path.abspath('spmbasics/data/output/workingdir')
...
datasink.inputs.base_directory = os.path.abspath(
    'spmbasics/data/output/workingdir/l1output')


def getstripdir(subject_id):
    import os
    return os.path.join(
        os.path.abspath('spmbasics/data/output/workingdir'),
