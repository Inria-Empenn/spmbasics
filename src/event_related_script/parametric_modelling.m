...
outputdir = fullfile(home, 'spmbasics', '/data/output/event_related_script/parametric');
matfile = fullfile(outputdir, 'SPM.mat');
...
matlabbatch{2}.spm.stats.fmri_est.spmmat = cellstr(matfile);
...
matlabbatch{3}.spm.stats.con.spmmat = cellstr(matfile);
matlabbatch{3}.spm.stats.con.consess{1}.fcon.name = 'Famous Lag';
matlabbatch{3}.spm.stats.con.consess{1}.fcon.weights = [zeros(2,6) eye(2)];

matlabbatch{4}.spm.stats.results.spmmat = cellstr(matfile);
matlabbatch{4}.spm.stats.results.conspec.contrasts  = 9;
matlabbatch{4}.spm.stats.results.conspec.threshdesc = 'none';
matlabbatch{4}.spm.stats.results.conspec.thresh     = 0.001;
matlabbatch{4}.spm.stats.results.conspec.extent     = 0;
matlabbatch{4}.spm.stats.results.conspec.mask.contrasts = 5;
matlabbatch{4}.spm.stats.results.conspec.mask.thresh    = 0.05;
matlabbatch{4}.spm.stats.results.conspec.mask.mtype     = 0;



save(fullfile(scriptdir,'parametric_modelling.mat'),'matlabbatch');


disp('Finished parametric modelling estimation');
